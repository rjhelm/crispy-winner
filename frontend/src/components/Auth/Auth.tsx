...
export default function Auth() {
    ...
    // Local state control modal windows + data fields
    ...
    const handleOnSubmit = (userName: string, userPass: string, callBack: Function) => {
        ...
        if (userPass.length < 6) {
            ...
            setUserPassErrorMsg('Passwords must be 6 characters or more');
            error = true;
    ...
    // Hadles login of account and calls sign in action
