...
async function main() {
    ...
    io.on('connection', function (socket: Socket) {
        ...
        socket.on('simple-chat-message', async (msg: Message) => {
            ...
            // format out action for client to parse
            action = { type: 'message', payload: msg };

            // Emit the message to everyone in the server
        ...
        // When user signs in, send over userId
        // Add to list of clients userId to idnetify socket.id
